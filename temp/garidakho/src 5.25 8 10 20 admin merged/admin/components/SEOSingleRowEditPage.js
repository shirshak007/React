...
export default function SingleRowEditPage(props) {
  ...
  const update = () => {
    ...
    var data = JSON.stringify({ "update": { "title": title, "keywords": keywords, "description": description, "page_url": page_url }, "id": id });
    ...
    <div className={classes.root}>
      ...
      >
        <div style={{ margin: "50px" }}>
          {loading ? <Sentry color="#727981" size={32} speed={1} animating={true} /> : null}
          {
            message != "" ? <div>{message}
              <Button
                fullWidth
