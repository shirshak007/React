...
export default function TermsAndCondition() {
  ...
  const page_details = async () => {
    var config = {
      method: "get",
      url: "http://garidakho.com/new_api/page_seo/?id=25",
      headers: {},
    };
  ...
  return (
    <div className={classes.container}>
      ...
      <div className={classes.paper}>
        ...
        <p>
          Welcome to <b>Garidakho Pvt. Ltd.</b> (“Company”, “we”, “our”, “us”)!
        </p>
        <p>
          These Terms of Service (“Terms”, “Terms of Service”) govern your use
          of our website located at <b>garidakho.com</b> (together or
          individually “Service”) operated by <b>Garidakho Pvt. Ltd.</b>.
        </p>
        <p>
        ...
        <p>
          ...
          <b>garidakho@gmail.com</b> so we can try to find a solution. These
        ...
        <p>
          ...
          Garidakho Pvt. Ltd. cancels it. You may cancel your Subscription
          renewal either through your online account management page or by
          contacting garidakho@gmail.com customer support team.
        </p>
        <p>
          A valid payment method is required to process the payment for your
          subscription. You shall provide Garidakho Pvt. Ltd. with accurate and
          ...
          information, you automatically authorize Garidakho Pvt. Ltd. to charge
          all Subscription fees incurred through your account to any such
          payment instruments.
        </p>
        <p>
          Should automatic billing fail to occur for any reason, Garidakho Pvt.
          Ltd. reserves the right to terminate your access to the Service with
          immediate effect.
        </p>
        <p>
          6. <b>Free Trial</b>
        ...
        <p>
          Garidakho Pvt. Ltd. may, at its sole discretion, offer a Subscription
        ...
        <p>
          ...
          Trial, you will not be charged by Garidakho Pvt. Ltd. until Free Trial
        ...
        <p>
          At any time and without notice, Garidakho Pvt. Ltd. reserves the right
        ...
        <p>
          Garidakho Pvt. Ltd., in its sole discretion and at any time, may
        ...
        <p>
          Garidakho Pvt. Ltd. will provide you with a reasonable prior notice of
        ...
        <p>
          Garidakho Pvt. Ltd. has the right but not the obligation to monitor
          and edit all Content provided by users.
        </p>
        <p>
          In addition, Content found on or through this Service are the property
          of Garidakho Pvt. Ltd. or used with permission. You may not
        ...
        <p>
          ...
          property of Garidakho Pvt. Ltd. and its licensors. Service is
          ...
          product or service without the prior written consent of Garidakho Pvt.
          Ltd..
        </p>
        <p>
        ...
        <p>
          ...
          to garidakho@gmail.com, with the subject line: “Copyright
        ...
        <p>
          You can contact our Copyright Agent via email at garidakho@gmail.com.
        </p>
        <p>
          17. <b>Error Reporting and Feedback</b>
        </p>
        <p>
          You may provide us either directly at garidakho@gmail.com or via third
        ...
        <p>
          ...
          that are not owned or controlled by Garidakho Pvt. Ltd..
        </p>
        <p>
          Garidakho Pvt. Ltd. has no control over, and assumes no responsibility
        ...
        <p style={{ marginTop: "5em", fontSize: "0.7em" }}>
          ...
          were created for <b>garidakho.com</b> by{" "}
