...
import FeaturedPost from "./childcomponents/FeaturedPost";
import BlogPosts from "./childcomponents/BlogPosts";
import LoadingAnimation from "./childcomponents/LoadingAnimation";
/*CUSTOM STYLE*/
...
export default function BlogMain() {
  ...
  const page_details = async () => {
    var config = {
      method: "get",
      url: "http://garidakho.com/new_api/page_seo/?id=27",
      headers: {},
    };
