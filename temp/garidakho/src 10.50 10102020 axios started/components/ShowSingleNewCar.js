...
import KeySpecificationNewCar from "./KeySpecificationNewCar";
...
export default function ShowSingleCar(props) {
  ...
  const [Found, isFound] = React.useState(false);
  const handleFound = () => {
    isFound(true);
  };
  return (
    <div className={classes.root}>
      <Helmet>
        ...
        <meta name="document_type" content={HelmetTags.document_type} />
      </Helmet>
      {sellingCarData.map((car) => {
        ...
        if (
          ...
          ("/car/" + car.title)
            .toUpperCase()
            .includes(props.location.pathname.toUpperCase()) //the checking is more insensitive using includes function to show used most relevant result
          //touppercase is used to perform case insensitive checking
          ...
          return (
            ...
            >
                ...
                <CardContent>
                  ...
                  <Grid container justify="center" spacing={2}>
                    ...
                    >
                      ...
                      {/*DIALOG BOX after clicking offer button-----------------------------------------------------------------*/}
                      <Dialog
                        open={OpenDialog}
              ...
              <NewCarOverview id={car.id} />
              {/*Key specs child component-----------------------------------------------*/}
              <KeySpecificationNewCar id={car.id} />
            </Container>
          );
        }
        return "";
      })}
      {Found ? "" : <div style={{ padding: "50px" }}>No Matches Found</div>}
      {/*SnackBar*-------------------------------------------*/}
      <Snackbar
        anchorOrigin={{
          vertical: "bottom",
