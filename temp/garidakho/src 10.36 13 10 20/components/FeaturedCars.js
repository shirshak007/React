...
const useStyles = makeStyles((theme) => ({
  ...
  imagebox: {
    width: "100%",
    height: 200 /*change the height always 30-40 pixel less than gridpaper. It contains the title of image*/,
    flexDirection: "row",
    alignItems: "center",
  },
  image: {
...
//Manage clicks and showing tabpanel----------------------------------------------------------------
function TabPanel(props) {
  ...
  return (
    <div
      role="tabpanel"
      hidden={value !== index}
      id={`featuredcar${index}`}
      aria-labelledby={`featuredcar-${index}`}
      {...other}
    >
      {value === index && (
        <Box p={3}>
...
function showtab(index) {
  return {
    id: `featuredcar-${index}`,
    "aria-controls": `featuredcar-${index}`,
  };
}
//--------------------------------------------------------------
